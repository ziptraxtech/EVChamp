...
SYSTEM_PROMPT = (
    ...
    "platform (evchamp.in) and its products: Zeflash, EVTruLife, Investyz, "
    ...
    "describe it. Example: `- **EVTruLife**: AI-powered battery diagnostics "
    "with real-time SoH and predicted range. [evchamp.in/evtrulife]"
    "(https://evchamp.in/evtrulife)`\n"
    ...
    "  EVTruLife / battery diagnostics / battery health → "
    "[evchamp.in/evtrulife](https://evchamp.in/evtrulife)\n"
