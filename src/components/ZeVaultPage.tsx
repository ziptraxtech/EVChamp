    ...
    <div className="min-h-screen bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950 text-slate-50">
      ...
      <header className="border-b border-slate-800 bg-slate-950/80 backdrop-blur">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 py-4 flex items-center justify-between">
          ...
          <button onClick={() => navigate('/zeflash-plans')} className="hidden sm:inline-flex items-center gap-2 rounded-lg bg-gradient-to-r from-cyan-500 to-blue-600 text-white text-xs sm:text-sm font-semibold px-3 sm:px-4 py-2 hover:from-cyan-600 hover:to-blue-700 shadow-md shadow-cyan-500/30">
            Add Money
          </button>
        </div>
      </header>
      ...
      <main className="max-w-5xl mx-auto px-4 sm:px-6 py-8 space-y-8">
        ...
        <section className="rounded-3xl border border-violet-700/50 bg-gradient-to-br from-violet-900/60 via-slate-950 to-indigo-900/60 p-6 sm:p-8 shadow-lg shadow-violet-900/40">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-6">
            ...
            <div className="space-y-3 w-full sm:w-auto sm:max-w-xs">
              <button onClick={() => navigate('/zeflash-plans')} className="w-full inline-flex items-center justify-center gap-2 rounded-xl bg-gradient-to-r from-cyan-500 to-blue-600 text-white text-sm font-semibold px-4 py-3 hover:from-cyan-600 hover:to-blue-700 shadow-lg shadow-cyan-500/40">
        ...
        <section className="rounded-2xl border border-slate-800 bg-slate-950/80 p-5 sm:p-6 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
          ...
          <button onClick={() => navigate('/zeflash-plans')} className="inline-flex shrink-0 items-center gap-2 rounded-xl bg-gradient-to-r from-cyan-500 to-blue-600 text-white text-sm font-semibold px-4 py-3 hover:from-cyan-600 hover:to-blue-700 shadow-lg shadow-cyan-500/40">
